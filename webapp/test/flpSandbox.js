		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Table Input Change with Traffic Lights",
									"targetURL": "#assemblercommxonchangetraffic-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"assemblercommxonchangetraffic-display": {
								"semanticObject": "assemblercommxonchangetraffic",
								"action": "display",
								"description": "Table Input Change with Traffic Lights App",
								"title": "Table Input Change with Traffic Lights",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=assembler.com.mx.onchangetraffic",
									"url": sap.ui.require.toUrl("assembler/com/mx/onchangetraffic")
								}
							}
						}
					}
